...
public class DockerComposePropertyLoaderTest {
    ...
    public void loadPropertiesFromPropertyFileDockerComposeCommand() {
        assertThat(DockerComposePropertyLoader.getInstance().getDockerComposeCommand(),
                is("test-compose"));
    }

    @Test
    public void loadPropertiesFromPropertyFileSudoCommand() {
        assertThat(DockerComposePropertyLoader.getInstance().getSudoCommand(),
                is("test-sudo"));
    }

    @Test
    public void loadPropertiesFromPropertyFileDockerHost() {
        assertThat(DockerComposePropertyLoader.getInstance().getDockerHost(),
                is("test-test"));
    }

    @Test
    public void loadPropertiesFromPropertyFileUseSudo() {
        assertThat(DockerComposePropertyLoader.getInstance().isUseSudo(),
                is(Boolean.TRUE));
    }
}
